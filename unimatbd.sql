...
-- Tiempo de generación: 18-11-2024 a las 11:09:25
...
CREATE TABLE `asistencia` (
  ...
  `estado_asistencia` enum('Puntual','Tardanza','Justificado') NOT NULL,
...
CREATE TABLE `concepto_pago` (
  `id_concepto_pago` bigint(20) NOT NULL,
  `nombre_concepto` varchar(100) NOT NULL,
  `descripcion` text DEFAULT NULL,
  `monto` float(6,2) NOT NULL,
  `tipo_concepto` enum('Matricula','Mensualidad','Material escolar','Extracurricular') NOT NULL,
...
CREATE TABLE `estado_notas` (
  `id_estado_notas` int(11) NOT NULL,
...
CREATE TABLE `estudiante` (
  ...
  `numero_whatsapp` int(9) NOT NULL,
...
CREATE TABLE `nota` (
  ...
  `nota_1` tinyint(4) DEFAULT NULL,
  `nota_2` tinyint(4) DEFAULT NULL,
  `nota_3` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `pago` (
  ...
  `tipo_pago` enum('Efectivo','Transferencia','Deposito') NOT NULL,
...
ALTER TABLE `concepto_pago`
  ...
  ADD KEY `id_tipo_concepto` (`tipo_concepto`);
...
--
-- Indices de la tabla `estado_notas`
--
ALTER TABLE `estado_notas`
  ADD PRIMARY KEY (`id_estado_notas`);
...
ALTER TABLE `nota`
  ...
  ADD KEY `id_alumno` (`id_asignacion`),
...
ALTER TABLE `pago`
  ...
  ADD KEY `id_estudiante` (`id_usuario`),
...
--
ALTER TABLE `aula`
  MODIFY `id_aula` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `concepto_pago`
--
ALTER TABLE `concepto_pago`
  MODIFY `id_concepto_pago` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `estado_notas`
--
ALTER TABLE `estado_notas`
  MODIFY `id_estado_notas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `estudiante`
--
ALTER TABLE `estudiante`
  MODIFY `id_estudiante` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT de la tabla `grado`
--
ALTER TABLE `grado`
  MODIFY `id_grado` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `modulo`
--
ALTER TABLE `modulo`
  MODIFY `id_modulo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `nota`
--
ALTER TABLE `nota`
  MODIFY `id_nota` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `periodo`
  MODIFY `id_periodo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `permisos`
--
ALTER TABLE `permisos`
  MODIFY `id_permiso` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
...
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `nota`
  ADD CONSTRAINT `nota_ibfk_2` FOREIGN KEY (`id_docente`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nota_ibfk_4` FOREIGN KEY (`id_periodo`) REFERENCES `periodo` (`id_periodo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nota_ibfk_5` FOREIGN KEY (`id_asignacion`) REFERENCES `asignacion` (`id_asignacion`) ON DELETE CASCADE ON UPDATE CASCADE;

...
<section>
  ...
  <div class="row">
    ...
    <div class="col-12 col-xl-5">
      <div class="">
        <button class="btn bg-color-sky-blue btn-notas m-3" type="button">Ver mis notas</button>
        <button class="btn bg-color-sky-blue btn-pays m-3" type="button">Ver mis pagos</button>
      </div>
      <div class=" " >
